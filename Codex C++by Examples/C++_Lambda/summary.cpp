...
// ================================================================================
// 編譯與執行（請先 cd 到本檔所在目錄）:
// g++ -std=c++20 -Wall -Wextra -Wpedantic -Wconversion -Wshadow -Werror -pthread 'summary.cpp' -o '/tmp/codex_cpp_C_Lambda_summary' && '/tmp/codex_cpp_C_Lambda_summary'
//
// === 預期輸出（節錄）===
// Lambda 面試總複習：capture、algorithm、type erasure、lifetime 皆通過
