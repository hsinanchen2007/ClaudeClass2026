...
// ================================================================================
// 編譯與執行（請先 cd 到本檔所在目錄）:
// g++ -std=c++20 -Wall -Wextra -Wpedantic -Wconversion -Wshadow -Werror -pthread '21_deadlock.cpp' -o '/tmp/codex_cpp_C_MultiThread_21_deadlock' && '/tmp/codex_cpp_C_MultiThread_21_deadlock'
//
// === 預期輸出（節錄）===
// deadlock：scoped_lock 與 callback 邊界測試通過
